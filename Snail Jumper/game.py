...
class Obstacle(pygame.sprite.Sprite):
    def __init__(self, obstacle_type, position=None):
        ...
        if obstacle_type == "snail":
            ...
            if position == "left":
                # flipping vertically
                snail_1 = pygame.transform.flip(snail_1, False, True)
                snail_2 = pygame.transform.flip(snail_2, False, True)
            else:
                # flipping vertically and horizontally
                snail_1 = pygame.transform.flip(snail_1, True, True)
                snail_2 = pygame.transform.flip(snail_2, True, True)
