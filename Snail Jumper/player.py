...
class Player(pygame.sprite.Sprite):
    def __init__(self, game_mode):
        ...
        # flipping vertically
        player_walk1 = pygame.transform.flip(player_walk1, False, True)
        player_walk2 = pygame.transform.flip(player_walk2, False, True)
        ...
        if self.game_mode == "Neuroevolution":
            ...
            layer_sizes = [self.obstacles_number_selcted + 1, 16, 8, 2]
    ...
    def flip_player_horizontally(self):
        ...
        for i, player_surface in enumerate(self.player_walk):
            self.player_walk[i] = pygame.transform.flip(player_surface, True, False)
